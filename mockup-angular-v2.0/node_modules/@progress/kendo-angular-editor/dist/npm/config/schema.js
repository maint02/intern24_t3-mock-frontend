...
var kendoTableNodes = function () {
    ...
    var nodes = prosemirror_tables_1.tableNodes({ tableGroup: tableGroup, cellContent: 'block+', cellAttributes: commonAttributes });
...
}); }, ɵ26 = function (node) { return ['img', util_1.removeEmptyEntries(node.attrs)]; }, ɵ27 = function () { return ['br']; }, ɵ28 = function (node) { return ['li', util_1.removeEmptyEntries(node.attrs), SLOT]; }, ɵ29 = function (dom) { return ({
