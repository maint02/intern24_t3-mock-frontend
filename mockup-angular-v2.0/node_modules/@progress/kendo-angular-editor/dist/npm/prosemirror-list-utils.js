...
function liftSelectionList(state, tr) {
    ...
    for (var i = listCol.length - 1; i >= 0; i--) {
        ...
        if (start.depth > 0) {
            ...
            if (range) {
                tr.lift(range, exports.getListLiftTarget(state.schema, start));
            }
        }
    }
    return tr;
...
function toggleUnorderedList(state, dispatch, view) {
    return exports.toggleList(state, dispatch, view, 'bulletList');
}
...
function toggleOrderedList(state, dispatch, view) {
    return exports.toggleList(state, dispatch, view, 'orderedList');
}
