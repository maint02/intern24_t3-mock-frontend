...
var firefox = kendo_angular_common_1.isDocumentAvailable() ? /Firefox/.test(navigator.userAgent) : false;
/**
...
var EditorComponent = /** @class */ (function () {
    ...
    EditorComponent.prototype.initialize = function () {
        ...
        this.ngZone.runOutsideAngular(function () {
            _this.view = new prosemirror_view_1.EditorView({ mount: _this.viewMountElement }, {
                state: state,
                dispatchTransaction: function (tr) {
                    ...
                    if (!prosemirror_utils_1.hasSameMarkup(value, that._previousValue)) {
        ...
        this.subs.add(rxjs_1.merge(this.stateChange.pipe(operators_1.filter(function () { return _this.updateInterval > 0; }), operators_1.auditTime(this.updateInterval)), this.stateChange.pipe(operators_1.filter(function () { return _this.updateInterval === 0; })))
            .subscribe(function () {
        ...
        this.subs.add(rxjs_1.merge(this.valueModified.pipe(operators_1.filter(function () { return _this.updateInterval > 0; }), operators_1.auditTime(this.updateInterval)), this.valueModified.pipe(operators_1.filter(function () { return _this.updateInterval === 0; })))
            .subscribe(function (value) {
            that.onChangeCallback(value);
            _this.valueChange.emit(value);
        }));
        this.subs.add(rxjs_1.fromEvent(this.viewMountElement, 'keyup').pipe(operators_1.map(function (e) { return e.keyCode; }), operators_1.filter(function (code) { return code === 121; }), // F10
        ...
        this.subs.add(rxjs_1.fromEvent(this.viewMountElement, 'blur').pipe(operators_1.filter(function (event) { return !_this.viewMountElement.contains(event.relatedTarget); }))
    ...
    EditorComponent.decorators = [
        { type: core_1.Component, args: [{
                    ...
                    providers: [
                        ...
                        {
                            provide: kendo_angular_common_2.KendoInput,
                            useExisting: core_1.forwardRef(function () { return EditorComponent; })
                        }
                    ],
