...
exports.activeNode = function (state) {
    var isAllSelection = state.selection instanceof prosemirror_state_1.AllSelection;
    var isTextSelection = state.selection instanceof prosemirror_state_1.TextSelection;
    var isNodeSelection = state.selection instanceof prosemirror_state_1.NodeSelection;
    var isCellSelection = state.selection instanceof prosemirror_tables_1.CellSelection;
    var node;
    if (isAllSelection) {
        node = state.doc;
    }
