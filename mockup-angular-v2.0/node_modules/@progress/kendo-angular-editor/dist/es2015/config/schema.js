...
const ɵ13 = kendoTableNodes;
const ɵ14 = (node) => (isEmpty(node.attrs) ? ['p', SLOT] : ['p', removeEmptyEntries(node.attrs), SLOT]), ɵ15 = (node) => ['blockquote', removeEmptyEntries(node.attrs), SLOT], ɵ16 = () => ['hr'], ɵ17 = (dom) => Object.assign({}, serializeDOMAttrs(dom), { level: 1 }), ɵ18 = (dom) => Object.assign({}, serializeDOMAttrs(dom), { level: 2 }), ɵ19 = (dom) => Object.assign({}, serializeDOMAttrs(dom), { level: 3 }), ɵ20 = (dom) => Object.assign({}, serializeDOMAttrs(dom), { level: 4 }), ɵ21 = (dom) => Object.assign({}, serializeDOMAttrs(dom), { level: 5 }), ɵ22 = (dom) => Object.assign({}, serializeDOMAttrs(dom), { level: 6 }), ɵ23 = (node) => {
    const attrs = removeEntries(node.attrs, key => key !== 'level');
    return ['h' + node.attrs.level, removeEmptyEntries(attrs), SLOT];
}, ɵ24 = () => ['pre', ['code', SLOT]], ɵ25 = (dom) => ({
    alt: dom.getAttribute('alt'),
    height: dom.getAttribute('height'),
    src: dom.getAttribute('src'),
    width: dom.getAttribute('width')
}), ɵ26 = (node) => ['img', removeEmptyEntries(node.attrs)], ɵ27 = () => ['br'], ɵ28 = (node) => ['li', removeEmptyEntries(node.attrs), SLOT], ɵ29 = (dom) => ({
    order: dom.hasAttribute('start') ? parseInt(dom.getAttribute('start'), 10) : 1
}), ɵ30 = node => (node.attrs.order === 1 ? ['ol', SLOT] : ['ol', { start: node.attrs.order }, SLOT]), ɵ31 = () => ['ul', SLOT];
/**
 * @hidden
 */
