 ...
 * @hidden
 */
export declare const removeEntries: (obj: Object, predicate: (key: string) => boolean) => Record<string, string>;
/**
 * @hidden
 */
export declare const removeEmptyEntries: (obj: Object) => Record<string, string>;
/**
 * @hidden
 */
