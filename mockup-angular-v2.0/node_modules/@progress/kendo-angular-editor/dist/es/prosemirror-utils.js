...
var _a = schema.nodes, bulletList = _a.bulletList, doc = _a.doc, listItem = _a.listItem, orderedList = _a.orderedList;
 ...
 * @hidden
 */
export var isMarkActive = function (state, markType) {
 ...
 * @hidden
 */
export var isNodeActive = function (state, nodeType, attrs) {
 ...
 * @hidden
 */
export var getNodeTagName = function (node) {
 ...
 * @hidden
 */
export var canIndent = function (state, nodeType) {
    return isNodeActive(state, nodeType) && sinkListItem(nodeType)(state);
};
/**
 * @hidden
 */
export var canOutdent = function (state, nodeType) {
