...
$input-line-height-lg: $input-line-height-lg !default;
...
$dropdownlist-focused-text: $button-pressed-text !default;
$dropdownlist-focused-bg: $button-pressed-bg !default;
$dropdownlist-focused-border: $button-pressed-border !default;
$dropdownlist-focused-gradient: $button-pressed-gradient !default;
$dropdownlist-focused-shadow: $button-focused-shadow !default;
...
// Listgroup
$listgroup-border-width: $list-group-border-width !default;
$listgroup-border-radius: $list-group-border-radius !default;

$listgroup-font-size: $font-size !default;
$listgroup-line-height: $line-height !default;

$listgroup-bg: $list-group-bg !default;
$listgroup-text: $list-group-color !default;
$listgroup-border: $list-group-border-color !default;

$listgroup-item-padding-x: $list-group-item-padding-x !default;
$listgroup-item-padding-y: $list-group-item-padding-y !default;
$listgroup-item-border-width: $list-group-border-width !default;
...
$grid-sticky-selected-alt-bg:  mix( mix( $grid-bg, contrast-wcag( $grid-bg ), 97% ), $selected-bg, 75% ) !default;

$grid-sticky-hovered-bg: $hovered-bg !default;
$grid-sticky-selected-hovered-bg: mix( mix( $grid-bg, contrast-wcag( $grid-bg ), 93.5% ), $selected-bg, 75% ) !default;
...
$card-footer-bg: $card-cap-bg !default;
$card-footer-text: $card-text !default;
$card-footer-border: $card-border-color !default;
...
$slider-button-focused-shadow: $button-focused-shadow !default;
...
$slider-track-bg: $progressbar-bg !default;
$slider-selection-bg: $progressbar-fill-bg !default;
...
$window-titlebar-padding-x: $modal-header-padding-x !default;
$window-titlebar-padding-y: $modal-header-padding-y !default;
$window-titlebar-border-width: 0 0 1px !default;
$window-titlebar-border-style: solid !default;

$window-title-spacing: 0;
$window-title-font-size: $font-size-lg !default;
$window-title-line-height: $modal-title-line-height !default;
...
$tooltip-closable-padding-y: $padding-y !default;
...
$breadcrumb-link-focused-shadow: inset 0 0 0 3px rgba($widget-text, .25) !default;
